        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 auto-rows-[320px]">
          {businesses.map((item, index) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-200 shadow-sm transition-all duration-500 hover:shadow-2xl ${item.gridClass}`}
            >
              <Image
                src={item.image}
                alt={item.title}
              ...
              {/* Overlay: Text visibility ke liye bottom heavy gradient */}
